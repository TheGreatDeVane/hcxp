...
describe BandsController do
  ...
  let(:valid_attributes) { FactoryGirl.attributes_for(:band) }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved band as @band" do
        ...
        post :create, {:band => { "name" => "invalid value" }}, valid_session
        expect(assigns(:band)).to be_a_new(Band)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested band" do
        ...
        expect_any_instance_of(Band).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => band.to_param, :band => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the band as @band" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Band.any_instance.stub(:save).and_return(false)
        put :update, {:id => band.to_param, :band => { "name" => "invalid value" }}, valid_session
        expect(assigns(:band)).to eq(band)
      end
